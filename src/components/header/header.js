...
export default function addMenu() {
    ...
    const menuButtonContainer = menuContainer.appendChild(document.createElement('div'));
    ...
    const menuButtonCup = menuContainer.appendChild(document.createElement('div'));
